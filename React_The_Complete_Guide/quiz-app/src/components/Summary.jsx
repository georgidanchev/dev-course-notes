...
export default function Summary({ userAnswers }) {
  ...
  const correctAnswersShares = Math.round((correctAnswers.length / userAnswers.length) * 100)
  const wrongAnswersShare = 100 - skippedAnswersShares - correctAnswersShares
