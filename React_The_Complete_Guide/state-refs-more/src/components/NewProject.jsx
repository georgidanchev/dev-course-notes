...
export default function NewPort({ onAdd }) {
  const modal = useRef()
  ...
  return (
    <>
      <Modal ref={modal} buttonCaption="Okay">
        <h2>Invalid Input</h2>
        <p>Ops.. looks like you forgot to enter a value.</p>
        <p>Please make sure you provide a valid value for everyone input field.</p>
      </Modal>
